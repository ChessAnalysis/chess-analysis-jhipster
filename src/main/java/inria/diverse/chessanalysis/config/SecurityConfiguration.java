package inria.diverse.chessanalysis.config;

import inria.diverse.chessanalysis.security.*;
import inria.diverse.chessanalysis.web.filter.CsrfCookieGeneratorFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            .authorizeRequests()
            .antMatchers("/rapport").permitAll()
            .antMatchers("/api/service/getMdFiles").permitAll()
            .antMatchers("/api/service/rapport/**").permitAll()
