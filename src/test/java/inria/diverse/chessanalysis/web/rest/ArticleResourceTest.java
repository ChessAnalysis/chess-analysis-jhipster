...
public class ArticleResourceTest {
    ...
    private static final String DEFAULT_SUBTITLE = "SAMPLE_TEXT";
    private static final String UPDATED_SUBTITLE = "UPDATED_TEXT";
    ...
    public void initTest() {
        ...
        article.setSubtitle(DEFAULT_SUBTITLE);
        article.setPath(DEFAULT_PATH);
    ...
    public void createArticle() throws Exception {
        ...
        assertThat(testArticle.getPath()).isEqualTo(DEFAULT_PATH);
    ...
    public void updateArticle() throws Exception {
        ...
        article.setSubtitle(UPDATED_SUBTITLE);
        article.setPath(UPDATED_PATH);
        ...
        assertThat(testArticle.getPath()).isEqualTo(UPDATED_PATH);
