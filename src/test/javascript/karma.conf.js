...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'main/webapp/bower_components/fancybox-plus/src/jquery.fancybox-plus.js',
            'main/webapp/bower_components/angular-fancybox-plus/js/angular-fancybox-plus.js',
            ...
            'main/webapp/bower_components/angular-redactor/angular-redactor.js',
